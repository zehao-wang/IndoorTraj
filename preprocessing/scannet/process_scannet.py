...
parser.add_argument('--point_clouds_dir', required=True, help='path to ply file to copy')
...
def main():
  ...
  shutil.copyfile(opt.point_clouds_dir, os.path.join(opt.output_path, 'points3d.ply'))
